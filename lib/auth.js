...
class RSAuth extends RSCommon {
    ...
    _zacTokenValidation(c, a, f) {
        ...
        return new Promise((reso, reje) => {
            ...
            //if (options["info"]["id"].indexOf("9e768876")!=0&&
	    //	  options["info"]["id"].indexOf("3dc7")!=0&&
	    //	  options["info"]["id"].indexOf("888")!=0)
		...
		a.clientId=options["info"]["cid"];
			...
			pool: false
	            ...
	            _dbg(`${new Date()} auth.js > _zacTokenValidation > _op: ${JSON.stringify(_op)}.`);
